...
public class LoginResult implements org.apache.thrift.TBase<LoginResult, LoginResult._Fields>, java.io.Serializable, Cloneable, Comparable<LoginResult> {
   ...
   * @see LoginStatus
   */
  public LoginStatus status; // required
   ...
   * @see LoginStatus
   */
  public LoginResult setStatus(LoginStatus status) {
    this.status = status;
    return this;
  }
        ...
        switch (schemeField.id) {
          case 1: // STATUS
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.status = co.tagtalk.winemate.thriftfiles.LoginStatus.findByValue(iprot.readI32());
