...
public class RewardItemRequest implements org.apache.thrift.TBase<RewardItemRequest, RewardItemRequest._Fields>, java.io.Serializable, Cloneable, Comparable<RewardItemRequest> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("RewardItemRequest");
  ...
  static {
    schemes.put(StandardScheme.class, new RewardItemRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new RewardItemRequestTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(RewardItemRequest.class, metaDataMap);
  }
   ...
   */
  public RewardItemRequest(RewardItemRequest other) {
  ...
  public RewardItemRequest deepCopy() {
    return new RewardItemRequest(this);
  }
  ...
  public RewardItemRequest setUserId(int userId) {
    this.userId = userId;
    setUserIdIsSet(true);
    return this;
  }
  ...
  public RewardItemRequest setWineryName(String wineryName) {
    this.wineryName = wineryName;
    return this;
  }
   ...
   * @see CountryId
   */
  public RewardItemRequest setCountryId(CountryId countryId) {
    this.countryId = countryId;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof RewardItemRequest)
      return this.equals((RewardItemRequest)that);
    return false;
  }

  public boolean equals(RewardItemRequest that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(RewardItemRequest other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("RewardItemRequest(");
    boolean first = true;
  ...
  private static class RewardItemRequestStandardSchemeFactory implements SchemeFactory {
    public RewardItemRequestStandardScheme getScheme() {
      return new RewardItemRequestStandardScheme();
    }
  }

  private static class RewardItemRequestStandardScheme extends StandardScheme<RewardItemRequest> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, RewardItemRequest struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, RewardItemRequest struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class RewardItemRequestTupleSchemeFactory implements SchemeFactory {
    public RewardItemRequestTupleScheme getScheme() {
      return new RewardItemRequestTupleScheme();
    }
  }

  private static class RewardItemRequestTupleScheme extends TupleScheme<RewardItemRequest> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, RewardItemRequest struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, RewardItemRequest struct) throws org.apache.thrift.TException {
